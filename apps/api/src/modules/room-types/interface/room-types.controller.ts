...
const createSchema = z
  .object({
    ...
    descriptionTh: z.string().trim().max(2000).nullable().optional(),
    bedConfig: z.string().trim().max(120).nullable().optional(),
    sizeSqm: z.number().int().min(1).max(10000).nullable().optional(),
